...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw MBCPMException(msg, "CVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw MBCPMException(ostr.str(), "CVecLabel::ScanLabelFile()");
         }
      }
   ...
   if(numOfAllLabel <= 0) 
      throw MBCPMException("Label set is empty!","CVecLabel::ScanLabelFile()");
...
void CVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw MBCPMException(msg, "CVecLabel::LoadLabels()");
   }
