...
class CVecFeature
{
   ...
   public:       
       ...
       */
      virtual void LoadFeatureMatrix(unsigned int start=0, unsigned int nparts=1,std::string filename="");
      ...
      virtual void StochasticComputeF(const TheMatrix& w, int* index, int batchsize, TheMatrix& f);
      ...
      virtual void ComputeStochasticGrad(const TheMatrix& l, TheMatrix& grad, int* indexs, int batchsize);
