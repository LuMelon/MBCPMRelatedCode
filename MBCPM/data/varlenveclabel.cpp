...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw MBCPMException(msg, "CVarLenVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw MBCPMException(ostr.str(), "CVarLenVecLabel::ScanLabelFile()");
         }
      }     
      numOfAllLabel++;
   }
   ...
   if(numOfAllLabel <= 0) 
      throw MBCPMException("Label set is empty!","CVarLenVecLabel::ScanLabelFile()");
...
void CVarLenVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw MBCPMException(msg, "CVarLenVecLabel::LoadLabels()");
   }
