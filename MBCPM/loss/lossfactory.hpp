      ...
      {         
         ...
         if(config.IsSet("Loss.lossFunctionType"))
         {
            ...
            { 
               ...
               {
                  throw MBCPMException("unable to cast data into CVecData",
...
//                {
//                   throw MBCPMException("unable to cast data into CMultilabelVecData",
//                                        "CLossFactory::GetLoss()");
//                }
...
//             else
//             {
//                throw MBCPMException("ERROR: unrecognised loss function ("+lossFunctionType+")\n", 
//                                     "CLossFactory::GetLoss()");
//             }
         }
         else
         {
            throw MBCPMException("ERROR: no loss function specified!\n", "CLossFactory::GetLoss()");
         }
         return loss;  
      }      
};
