...
class CLoss {
   ...
   public:
      ...
      void StochasticIndex(int *array,int batchsize, int len);
       ...
       *  @param grad [write] value of the gradient.
       */
      virtual void InitStochasticSolver(int batchsize)=0;

      virtual void StochasticComputeLossAndGradient(double& loss, TheMatrix& grad, int batchsize)=0;
