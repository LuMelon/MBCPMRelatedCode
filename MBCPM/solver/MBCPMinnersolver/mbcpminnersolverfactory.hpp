 ...
 *
 * When you subclass the MBCPMInnerSolver class, you must add an entry into
 * this factory class.
 */
class MBCPMInnerSolverFactory 
{
   public:
       ...
       *
       */
      static MBCPMInnerSolver* GetBMRMInnerSolver(CModel &model, double lambda)
      {
         MBCPMInnerSolver* innerSolver = 0;
         ...
         if(config.IsSet("BMRM.innerSolverType"))
            ...
            throw MBCPMException("No BMRM inner solver specified", "MBCPMInnerSolverFactory::GetBMRMInnerSolver()");
...
// #endif
         ...
         {
            throw MBCPMException("unknown innerSolverType <" + innerSolverType + ">", 
                                 "MBCPMInnerSolverFactory::GetBMRMInnerSolver()");
         }
