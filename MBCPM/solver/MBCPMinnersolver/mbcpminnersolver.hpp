...
{  
   ...
   public:
      /** Constructors
       */
      MBCPMInnerSolver(double lambda);
      
      
      /** Destructor
       */
      virtual ~MBCPMInnerSolver(){}
      ...
      virtual void SinkGradSet(double * ScalingVec,double totalScale,std::vector<bool> &sink)=0;
      /** slow node's grad submitted to update the gradient set 
      */
      // virtual void ChangeGradSet(TheMatrix &a, double b,int clock)=0;
