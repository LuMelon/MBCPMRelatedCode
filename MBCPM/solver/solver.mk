...
INNER_SOLVER_OBJ = mbcpminnersolver.o l2n2_bmrmdualinnersolver.o\
...
# solver objects
MBCPM.o: ${SOLVER_DIR}/MBCPM.hpp ${SOLVER_DIR}/MBCPM.cpp
	${CXX} ${CFLAGS} -c ${SOLVER_DIR}/MBCPM.cpp

mbcpminnersolver.o: ${INNER_SOLVER_DIR}/mbcpminnersolver.hpp ${INNER_SOLVER_DIR}/mbcpminnersolver.cpp
	${CXX} ${CFLAGS} -c ${INNER_SOLVER_DIR}/mbcpminnersolver.cpp

l2n2_bmrmdualinnersolver.o: ${INNER_SOLVER_DIR}/l2n2_bmrmdualinnersolver.hpp ${INNER_SOLVER_DIR}/l2n2_bmrmdualinnersolver.cpp mbcpminnersolver.o
