UTILITIES_OBJ = sml.o common.o configuration.o mbcpmexception.o timer.o
...
mbcpmexception.o: ${UTILITIES_DIR}/mbcpmexception.hpp ${UTILITIES_DIR}/mbcpmexception.cpp
	${CXX} ${CFLAGS} -c ${UTILITIES_DIR}/mbcpmexception.cpp
