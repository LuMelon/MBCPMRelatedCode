...
{  
        ...
        throw (MBCPMException("No double ("+name+") defined!",
...
{  
        ...
        throw (MBCPMException("No double vector ("+name+") defined!",
...
{  
        ...
        throw (MBCPMException("No int ("+name+") defined!",
...
{  
        ...
        throw (MBCPMException("No int vector ("+name+") defined!",
...
{  
        ...
        throw (MBCPMException("No bool ("+name+") defined!",
...
{  
        ...
        throw (MBCPMException("No bool vector ("+name+") defined!",
...
string Configuration::GetString(string name)
{
        ...
        throw (MBCPMException("No string ("+name+") defined!",
...
void Configuration::ReadFromFile(string filename)
{
        ...
        if(not f.good())
        {
                throw MBCPMException("Unable to read configuration from " + filename, 
        ...
        while (! f.eof())
        {
                ...
                {
                        throw MBCPMException("Cannot read line " + line + " from file " + filename, 
                                             "Configuration::ReadFromFile()");
                }
        }
        f.close();
