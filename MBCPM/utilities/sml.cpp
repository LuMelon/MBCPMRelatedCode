...
std::string TheMatrix::ToString()
{
        ostringstream oss;
        switch(type)
        {
                case SML::DENSE_VECTOR: oss << (*dv) ; break;
                case SML::DENSE_MATRIX: oss << (*dm) ; break;
                case SML::SPARSE_VECTOR: oss << (*sv) ; break;
                case SML::SPARSE_MATRIX: oss << (*sm) ; break;
                case SML::DENSE_MATRIX_ROW: oss << (*dmr) ; break;
                case SML::SPARSE_MATRIX_ROW: oss << (*smr) ; break;
        }
        return oss.str();
}
...
//TheMatrix* TheMatrix::CreateMatrixColView(const unsigned int& index)
//{
//        assert(type == SML::SPARSE_MATRIX || type == SML::DENSE_MATRIX);
//   
//        TheMatrix *mat_row = new TheMatrix();
...
//        {
//                case SML::SPARSE_MATRIX:
//                        mat_row->smr = new ublas::matrix_row<ublas::compressed_matrix<double> >(ublas::trans(*sm),index);
//                        mat_row->type = SML::SPARSE_MATRIX_ROW;
//                        mat_row->row = 1;
//                        mat_row->column = mat_row->smr->size();
//                        mat_row->dense_or_sparse = SML::SPARSE;
...
//         
//                case SML::DENSE_MATRIX:
//                        mat_row->dmr = new ublas::matrix_row<ublas::matrix<double> >(ublas::trans(*dm),index);
//                        mat_row->type = SML::DENSE_MATRIX_ROW;
//                        mat_row->row = 1;
//                        mat_row->column = mat_row->dmr->size();
//                        mat_row->dense_or_sparse = SML::DENSE;
...
//void TheMatrix::CreateMatrixColView(const unsigned int& index, TheMatrix* mat_row)
//{
//        assert(type == SML::SPARSE_MATRIX || type == SML::DENSE_MATRIX);
//        assert(mat_row);
//        
