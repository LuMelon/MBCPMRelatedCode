...
{  
        ...
        throw (AdgradException("No double ("+name+") defined!",
...
{  
        ...
        throw (AdgradException("No double vector ("+name+") defined!",
...
{  
        ...
        throw (AdgradException("No int ("+name+") defined!",
...
{  
        ...
        throw (AdgradException("No int vector ("+name+") defined!",
...
{  
        ...
        throw (AdgradException("No bool ("+name+") defined!",
...
{  
        ...
        throw (AdgradException("No bool vector ("+name+") defined!",
...
string Configuration::GetString(string name)
{
        ...
        throw (AdgradException("No string ("+name+") defined!",
...
void Configuration::ReadFromFile(string filename)
{
        ...
        if(not f.good())
        {
                throw AdgradException("Unable to read configuration from " + filename, 
        ...
        while (! f.eof())
        {
                ...
                {
                        throw AdgradException("Cannot read line " + line + " from file " + filename, 
                                             "Configuration::ReadFromFile()");
                }
        }
        f.close();
