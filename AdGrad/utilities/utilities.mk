UTILITIES_OBJ = sml.o common.o configuration.o Adgradexception.o timer.o
...
Adgradexception.o: ${UTILITIES_DIR}/Adgradexception.hpp ${UTILITIES_DIR}/Adgradexception.cpp
	${CXX} ${CFLAGS} -c ${UTILITIES_DIR}/Adgradexception.cpp
