...
{ 
    ...
    if(!featureFp.good()) 
    {
        ...
        throw AdgradException(msg, "CVecFeature::ScanFeatureFile()");
    }
...
//                                        throw AdgradException(ostr.str(), "CVecFeature::ScanFeatureFile()");
//                                }
...
void CVecFeature::LoadFeatures()
{
    ...
    {    
        ...
        throw AdgradException(msg, "CVecFeature::LoadFeatures()");
    }
