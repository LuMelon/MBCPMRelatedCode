...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw AdgradException(msg, "CVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw AdgradException(ostr.str(), "CVecLabel::ScanLabelFile()");
         }
      }
   ...
   if(numOfAllLabel <= 0) 
      throw AdgradException("Label set is empty!","CVecLabel::ScanLabelFile()");
...
void CVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw AdgradException(msg, "CVecLabel::LoadLabels()");
   }
