...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw AdgradException(msg, "CVarLenVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw AdgradException(ostr.str(), "CVarLenVecLabel::ScanLabelFile()");
         }
      }     
      numOfAllLabel++;
   }
   ...
   if(numOfAllLabel <= 0) 
      throw AdgradException("Label set is empty!","CVarLenVecLabel::ScanLabelFile()");
...
void CVarLenVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw AdgradException(msg, "CVarLenVecLabel::LoadLabels()");
   }
