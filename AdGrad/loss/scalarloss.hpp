...
class CScalarLoss : public CLoss 
{
   protected:
      ...
      virtual void StochasticLossAndGrad(double& loss, TheMatrix& f, TheMatrix& l, int* indexs, int batchsize)=0;
   ...
   public:      
      ...
      virtual void InitStochasticSolver(int batchsize);
      virtual void StochasticComputeLossAndGradient(double& loss, TheMatrix& grad, int batchsize);
