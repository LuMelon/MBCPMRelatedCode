      ...
      {         
         ...
         if(config.IsSet("Loss.lossFunctionType"))
         {
            ...
            { 
               ...
               {
                  throw AdgradException("unable to cast data into CVecData",
...
//                {
//                   throw AdgradException("unable to cast data into CMultilabelVecData",
//                                        "CLossFactory::GetLoss()");
//                }
...
//             else
//             {
//                throw AdgradException("ERROR: unrecognised loss function ("+lossFunctionType+")\n", 
//                                     "CLossFactory::GetLoss()");
//             }
         }
         else
         {
            throw AdgradException("ERROR: no loss function specified!\n", "CLossFactory::GetLoss()");
         }
         return loss;  
      }      
};
