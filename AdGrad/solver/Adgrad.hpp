...
class Adgrad : public CSolver
{
   public:
       ...
       */
      Adgrad(CModel* model, CLoss* loss, int _procID=0, int _nProc=1);
   ...
   protected:
      ...
      void UpdateModel(double* model,double* multiplier,double* gradient, double residual, int len);
