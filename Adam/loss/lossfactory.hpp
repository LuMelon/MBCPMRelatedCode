      ...
      {         
         ...
         if(config.IsSet("Loss.lossFunctionType"))
         {
            ...
            { 
               ...
               {
                  throw AdamException("unable to cast data into CVecData",
...
//                {
//                   throw AdamException("unable to cast data into CMultilabelVecData",
//                                        "CLossFactory::GetLoss()");
//                }
...
//             else
//             {
//                throw AdamException("ERROR: unrecognised loss function ("+lossFunctionType+")\n", 
//                                     "CLossFactory::GetLoss()");
//             }
         }
         else
         {
            throw AdamException("ERROR: no loss function specified!\n", "CLossFactory::GetLoss()");
         }
         return loss;  
      }      
};
