UTILITIES_OBJ = sml.o common.o configuration.o adamexception.o timer.o
...
adamexception.o: ${UTILITIES_DIR}/adamexception.hpp ${UTILITIES_DIR}/adamexception.cpp
	${CXX} ${CFLAGS} -c ${UTILITIES_DIR}/adamexception.cpp
