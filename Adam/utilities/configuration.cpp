...
{  
        ...
        throw (AdamException("No double ("+name+") defined!",
...
{  
        ...
        throw (AdamException("No double vector ("+name+") defined!",
...
{  
        ...
        throw (AdamException("No int ("+name+") defined!",
...
{  
        ...
        throw (AdamException("No int vector ("+name+") defined!",
...
{  
        ...
        throw (AdamException("No bool ("+name+") defined!",
...
{  
        ...
        throw (AdamException("No bool vector ("+name+") defined!",
...
string Configuration::GetString(string name)
{
        ...
        throw (AdamException("No string ("+name+") defined!",
...
void Configuration::ReadFromFile(string filename)
{
        ...
        if(not f.good())
        {
                throw AdamException("Unable to read configuration from " + filename, 
        ...
        while (! f.eof())
        {
                ...
                {
                        throw AdamException("Cannot read line " + line + " from file " + filename, 
                                             "Configuration::ReadFromFile()");
                }
        }
        f.close();
