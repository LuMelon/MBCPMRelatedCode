...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw AdamException(msg, "CVarLenVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw AdamException(ostr.str(), "CVarLenVecLabel::ScanLabelFile()");
         }
      }     
      numOfAllLabel++;
   }
   ...
   if(numOfAllLabel <= 0) 
      throw AdamException("Label set is empty!","CVarLenVecLabel::ScanLabelFile()");
...
void CVarLenVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw AdamException(msg, "CVarLenVecLabel::LoadLabels()");
   }
