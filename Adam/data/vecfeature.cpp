...
{ 
    ...
    if(!featureFp.good()) 
    {
        ...
        throw AdamException(msg, "CVecFeature::ScanFeatureFile()");
    }
...
//                                        throw AdamException(ostr.str(), "CVecFeature::ScanFeatureFile()");
//                                }
...
void CVecFeature::LoadFeatures()
{
    ...
    {    
        ...
        throw AdamException(msg, "CVecFeature::LoadFeatures()");
    }
