...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw AdamException(msg, "CVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw AdamException(ostr.str(), "CVecLabel::ScanLabelFile()");
         }
      }
   ...
   if(numOfAllLabel <= 0) 
      throw AdamException("Label set is empty!","CVecLabel::ScanLabelFile()");
...
void CVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw AdamException(msg, "CVecLabel::LoadLabels()");
   }
