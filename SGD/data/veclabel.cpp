...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw SGDException(msg, "CVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw SGDException(ostr.str(), "CVecLabel::ScanLabelFile()");
         }
      }
   ...
   if(numOfAllLabel <= 0) 
      throw SGDException("Label set is empty!","CVecLabel::ScanLabelFile()");
...
void CVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw SGDException(msg, "CVecLabel::LoadLabels()");
   }
