...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw SGDException(msg, "CVarLenVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw SGDException(ostr.str(), "CVarLenVecLabel::ScanLabelFile()");
         }
      }     
      numOfAllLabel++;
   }
   ...
   if(numOfAllLabel <= 0) 
      throw SGDException("Label set is empty!","CVarLenVecLabel::ScanLabelFile()");
...
void CVarLenVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw SGDException(msg, "CVarLenVecLabel::LoadLabels()");
   }
