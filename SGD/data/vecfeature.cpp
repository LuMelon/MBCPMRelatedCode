...
{ 
    ...
    if(!featureFp.good()) 
    {
        ...
        throw SGDException(msg, "CVecFeature::ScanFeatureFile()");
    }
...
//                                        throw SGDException(ostr.str(), "CVecFeature::ScanFeatureFile()");
//                                }
...
void CVecFeature::LoadFeatures()
{
    ...
    {    
        ...
        throw SGDException(msg, "CVecFeature::LoadFeatures()");
    }
