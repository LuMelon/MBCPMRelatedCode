...
{  
        ...
        throw (SGDException("No double ("+name+") defined!",
...
{  
        ...
        throw (SGDException("No double vector ("+name+") defined!",
...
{  
        ...
        throw (SGDException("No int ("+name+") defined!",
...
{  
        ...
        throw (SGDException("No int vector ("+name+") defined!",
...
{  
        ...
        throw (SGDException("No bool ("+name+") defined!",
...
{  
        ...
        throw (SGDException("No bool vector ("+name+") defined!",
...
string Configuration::GetString(string name)
{
        ...
        throw (SGDException("No string ("+name+") defined!",
...
void Configuration::ReadFromFile(string filename)
{
        ...
        if(not f.good())
        {
                throw SGDException("Unable to read configuration from " + filename, 
        ...
        while (! f.eof())
        {
                ...
                {
                        throw SGDException("Cannot read line " + line + " from file " + filename, 
                                             "Configuration::ReadFromFile()");
                }
        }
        f.close();
