      ...
      {         
         ...
         if(config.IsSet("Loss.lossFunctionType"))
         {
            ...
            { 
               ...
               {
                  throw SGDException("unable to cast data into CVecData",
...
//                {
//                   throw SGDException("unable to cast data into CMultilabelVecData",
//                                        "CLossFactory::GetLoss()");
//                }
...
//             else
//             {
//                throw SGDException("ERROR: unrecognised loss function ("+lossFunctionType+")\n", 
//                                     "CLossFactory::GetLoss()");
//             }
         }
         else
         {
            throw SGDException("ERROR: no loss function specified!\n", "CLossFactory::GetLoss()");
         }
         return loss;  
      }      
};
