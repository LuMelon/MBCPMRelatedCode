...
{  
        ...
        throw (MomentumException("No double ("+name+") defined!",
...
{  
        ...
        throw (MomentumException("No double vector ("+name+") defined!",
...
{  
        ...
        throw (MomentumException("No int ("+name+") defined!",
...
{  
        ...
        throw (MomentumException("No int vector ("+name+") defined!",
...
{  
        ...
        throw (MomentumException("No bool ("+name+") defined!",
...
{  
        ...
        throw (MomentumException("No bool vector ("+name+") defined!",
...
string Configuration::GetString(string name)
{
        ...
        throw (MomentumException("No string ("+name+") defined!",
...
void Configuration::ReadFromFile(string filename)
{
        ...
        if(not f.good())
        {
                throw MomentumException("Unable to read configuration from " + filename, 
        ...
        while (! f.eof())
        {
                ...
                {
                        throw MomentumException("Cannot read line " + line + " from file " + filename, 
                                             "Configuration::ReadFromFile()");
                }
        }
        f.close();
