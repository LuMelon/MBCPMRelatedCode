...
{  
   ...
   if(!labelFp.good()) 
   {
      ...
      throw MomentumException(msg, "CVarLenVecLabel::ScanLabelFile()");
   }
      ...
      {       
         ...
         else 
         {
            ...
            ostr << "Label file contains invalid label at line " << numOfAllLabel+1 << "!\n" 
                 << "Token: " << token << "\n";
            throw MomentumException(ostr.str(), "CVarLenVecLabel::ScanLabelFile()");
         }
      }     
      numOfAllLabel++;
   }
   ...
   if(numOfAllLabel <= 0) 
      throw MomentumException("Label set is empty!","CVarLenVecLabel::ScanLabelFile()");
...
void CVarLenVecLabel::LoadLabels()
{
   ...
   {
      string msg = "Cannot open label file <" + labelFile + ">!";
      throw MomentumException(msg, "CVarLenVecLabel::LoadLabels()");
   }
