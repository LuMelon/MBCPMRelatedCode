...
//                throw MomentumException(msg, "CSeqFeature::ScanFeatureFile()");
//        }
//   
...
//                
//        if(featureFp.eof())
//                throw MomentumException("Feature file does not contain valid examples","CSeqFeature::LoadFeatures()");
//        
//        // read sequences
//        nnz = 0;
...
//                
//                if(featureFp.eof())
//                        throw MomentumException("Feature file does not contain valid phi:*","CSeqFeature::LoadFeatures()");
//                
//                if(!firstSeq && ((tmpSeqNum - prevTmpSeqNum) != 1))
//                        throw MomentumException("sequence numbers must be consecutive and in increasing order","CSeqFeature::LoadFeatures()");
//                
...
//                        throw MomentumException("Feature file does not contain valid phi:1 tag","CSeqFeature::LoadFeatures()");                        
//                
...
//                        {
//                                cout << token << endl;
//                                throw MomentumException("Feature file does not contain valid pos tag in phi:1","CSeqFeature::LoadFeatures()");
//                        }
//                        
...
//                                        throw MomentumException(msg.str(),"CSeqFeature::LoadFeatures()");
//                                }
...
//                
//                if(phi_1.size() < 1)
//                        throw MomentumException("Feature file does not contain valid phi:1","CSeqFeature::LoadFeatures()");
//                
//                if(featureFp.eof() || (phiNum != 2))
//                        throw MomentumException("Feature file does not contain valid phi:2","CSeqFeature::LoadFeatures()");
//                
...
//                                throw MomentumException("Feature file contains invalid pos tag in phi:2","CSeqFeature::LoadFeatures()");
//                        
...
//                        
//                        if(featureCnt == 0)
//                                throw MomentumException("Feature file contains invalid phi:2 sparse vector","CSeqFeature::LoadFeatures()");
//                        
...
//                
//                if(phi_2.size() < 1)
//                        throw MomentumException("Feature file contains no phi:2","CSeqFeature::LoadFeatures()");
//        }
//        
//        // data matrix density
...
//	fscanf(ifp,"globalFeatureDim:%d\n",&featureDimension);q
        ...
        {
                string msg = "Cannot open feature file <" + featureFile + ">!";
                throw MomentumException(msg, "CSeqFeature::LoadFeatures()");  
        }
