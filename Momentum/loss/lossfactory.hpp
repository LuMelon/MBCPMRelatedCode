      ...
      {         
         ...
         if(config.IsSet("Loss.lossFunctionType"))
         {
            ...
            { 
               ...
               {
                  throw MomentumException("unable to cast data into CVecData",
...
//                {
//                   throw MomentumException("unable to cast data into CMultilabelVecData",
//                                        "CLossFactory::GetLoss()");
//                }
...
//             else
//             {
//                throw MomentumException("ERROR: unrecognised loss function ("+lossFunctionType+")\n", 
//                                     "CLossFactory::GetLoss()");
//             }
         }
         else
         {
            throw MomentumException("ERROR: no loss function specified!\n", "CLossFactory::GetLoss()");
         }
         return loss;  
      }      
};
